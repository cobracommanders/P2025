...
public class WristPositions {
    ...
    public static final double L2 = 0.47;
    public static final double L3 = 0.47;
    public static final double L4 = 0.41;
    ...
    public static final double INVERTED_CORAL_STATION = 0.05;
}
