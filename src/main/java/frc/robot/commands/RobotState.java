...
public enum RobotState {
  PREPARE_IDLE(false, false, new LEDState(Color.kPurple, Patterns.FAST_BLINK)),
  WAIT_IDLE(false, false,  new LEDState(Color.kBlue, Patterns.SOLID)),
  IDLE(false, false,  new LEDState(Color.kBlue, Patterns.SOLID)),
  PREPARE_INVERTED_IDLE(false, true,  new LEDState(Color.kPurple, Patterns.FAST_BLINK)),
  ...
  PREPARE_DEEP_CLIMB(true, false,  new LEDState(Color.kPurple, Patterns.FAST_BLINK)),
  WAIT_DEEP_CLIMB(true, false,  new LEDState(Color.kGreen, Patterns.SOLID)),
  DEEP_CLIMB(true, false,  new LEDState(Color.kWhite, Patterns.SOLID)),
  PREPARE_L1(false, true,  new LEDState(Color.kPurple, Patterns.FAST_BLINK)),
  WAIT_L1(false, true,  new LEDState(Color.kWhite, Patterns.SOLID)),
  SCORE_L1(false, true,  new LEDState(Color.kGreen, Patterns.SOLID)),
  PREPARE_L2(false, false,  new LEDState(Color.kPurple, Patterns.FAST_BLINK)),
  WAIT_L2(false, false,  new LEDState(Color.kWhite, Patterns.SOLID)),
  SCORE_L2(false, false,  new LEDState(Color.kGreen, Patterns.SOLID)),
  PREPARE_L3(false, false,  new LEDState(Color.kPurple, Patterns.FAST_BLINK)),
  WAIT_L3(false, false,  new LEDState(Color.kWhite, Patterns.SOLID)),
  SCORE_L3(false, false,  new LEDState(Color.kGreen, Patterns.SOLID)),
  PREPARE_L4(false, false,  new LEDState(Color.kPurple, Patterns.FAST_BLINK)),
  WAIT_L4(false, false,  new LEDState(Color.kWhite, Patterns.SOLID)),
  ...
  CAPPED_L4(false, false,  new LEDState(Color.kWhite, Patterns.SLOW_BLINK)),
