...
public enum RobotState {
  ...
  PREPARE_CORAL_STATION(false, false,  new LEDState(Color.kPurple, Patterns.SLOW_BLINK)),
  INTAKE_CORAL_STATION(false, false,  new LEDState(Color.kWhite, Patterns.SOLID)),
  PREPARE_INVERTED_CORAL_STATION(false, true,  new LEDState(Color.kPurple, Patterns.SLOW_BLINK)),
  ...
  PREPARE_INVERTED_FROM_IDLE(true, true,  new LEDState(Color.kPurple, Patterns.SLOW_BLINK)),
  PREPARE_IDLE_FROM_INVERTED(true, true,  new LEDState(Color.kPurple, Patterns.SLOW_BLINK)),
